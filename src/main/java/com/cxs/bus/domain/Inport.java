...
public class Inport {
    ...
    public Inport(Integer id, String paytype, Date inporttime, String operateperson, Integer number, String remark, Double inportprice, Integer providerid, Integer goodsid) {
        this.id = id;
